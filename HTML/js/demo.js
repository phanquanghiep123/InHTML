 ...
 */
{
    ...
    class Slide {
        ...
        setCurrent(isCurrent = true) {
            ...
            this.shape = document.querySelector('svg.shape');
            this.shape.style.fill=  (this.DOM.el.getAttribute("data-bg"));
        }
        // Hide the slide.
        hide(direction) {
        ...
        show(direction) {
            try {
                document.getElementById("logo").className = (this.DOM.el.getAttribute("data-logo"));
                document.getElementById("contact").className = (this.DOM.el.getAttribute("data-contact"));
            } catch (error) {
                console.log(error);
            }
    ...
    class Slideshow {
        constructor(el) {
            ...
            this.DOM.detailsWrap = document.querySelector('.slideshow');
            // Each group of details boxes for each slide/product.
            this.DOM.details = Array.from(this.DOM.detailsWrap.querySelectorAll('.slide'));
            // The slides.
            this.slides = [];
